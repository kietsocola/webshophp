...
<?php
	$pageTitle = "GIÀY ". $resultCat['tenLoai']." | GIÀY B.STORE - Hệ thống  thể thao chính hãng";
							...
							<div class="product-single-sidebar">
								...
								<ul>
									<?php 
										...
										$querySize = mysqli_query($conn, "SELECT *, COUNT(maSanPham) FROM `tbl_sanpham` WHERE trangThaiSanPham = '1' AND maLoai = '$idLoai' GROUP BY sotap ");
										while ($fetchSize = mysqli_fetch_assoc($querySize)){

									?>
									<li>
										<span class="fa fa-angle-double-right"></span>
										<a href="shop-list.php?maLoai=<?php echo $idLoai; ?>&size=<?php echo $fetchSize['sotap'];  ?>"><?php echo $fetchSize['sotap'];  ?><span> (<?php echo $fetchSize['COUNT(maSanPham)'];  ?>)</span></a>
										<?php 
