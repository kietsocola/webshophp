					...
					<div class="company-facality-row">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
							<div class="single-facality">
								...
								<div class="facality-text">
									<h3 class="facality-heading-text">CẬP NHẬT MỖI NGÀY</h3>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
							<div class="single-facality">
								...
								<div class="facality-text">
									<h3 class="facality-heading-text">30 NGÀY ĐỔI TRẢ</h3>
						...
						<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
							...
							<div class="footer-top-left">
								...
								<div class="newsletter-area">
									...
									<p>Đăng ký để nhận cập nhật sản phẩm hằng ngày cũng như khuyến mãi hấp dẫn.</p>
									<form action="#">
								...
								<div class="about-us-area">
									<h2>VỀ CHÚNG TÔI</h2>
									<p>B.STORE - Hệ thống  thể thao chính hãng</p>
								</div>
								<!-- ABOUT-US-AREA END -->
								<!-- FLLOW-US-AREA START -->
								...
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hidden-sm">
										...
										<div class="staticblock">
											<h2>GIỚI THIỆU</h2>
											<p>B.STORE được thành lập vào năm 2020. Nhằm giúp các bạn có thể mua được những đôi  chất lượng tốt và chính hãng.</p>
										</div>
										<!-- STATICBLOCK END -->
									</div>
										...
										<div class="fotter-menu-widget">
											<div class="single-f-widget">
												...
												<ul>
													...
													<li><a href="#"><i class="fa fa-angle-double-right"></i>Sản phẩm khuyến mãi</a></li>
													<li><a href="#"><i class="fa fa-angle-double-right"></i>Sản phẩm bán chạy</a></li>
													<li><a href="contact-us.php"><i class="fa fa-angle-double-right"></i>Liên hệ chúng tôi</a></li>
												</ul>
											</div>
										</div>
										<!-- FOTTER-MENU-WIDGET END -->
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										...
										<div class="fotter-menu-widget">
											<div class="single-f-widget">
												...
												<ul>
													<li><a href="#"><i class="fa fa-angle-double-right"></i>Dách sách đơn hàng</a></li>
													<li><a href="#"><i class="fa fa-angle-double-right"></i>Thẻ tín dụng</a></li>
