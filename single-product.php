...
?>		
<?php
	$pageTitle = $resultProd['tenSanPham']. " | SÁCH B.STORE - Hệ thống bán sách hay";
								...
								<div class="single-product-descirption">	
									...
									<div class="single-product-add-cart">
												...
												<div class="single-product-size">
													<p class="small-title">Số Tập: </p> 
													<select name="product-size" id="product-size">
														<option value="<?php echo $resultProd["sotap"]; ?>"><?php echo $resultProd["sotap"]; ?></option>	
													</select>
												</div>
