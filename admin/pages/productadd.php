                        ...
                        ?>   
                            <form  method="POST" enctype="multipart/form-data" name="formUser" onsubmit="return validationForm();"> <!--enctype để có thể thêm hình ảnh -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="inputAddProduct" name="sotap" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <input type="text" onblur="checkQuantity()" id="quantity" name="soLuongSanPham" value="1" class="inputAddProduct" required>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <input type="text" onblur = "checkprice()" id= "price" name="giaSanPham" placeholder="Nhập giá..." class="inputAddProduct" required>
                                    </td>
                                </tr>
        ...
        <script type="text/javascript">
            function checkQuantity(){
                ...
                if(quantity < 0)
                {
                    ...
                    alert("không được nhập số bé hơn 0");
                }
            }
            function checkprice(){
                ...
                if ( price < 0)
                {
                    ...
                    alert ("giá không được phép âm")
                }
            }
            function validationForm(){

                var maLoai=document.formUser.maLoai.value; 
                var sotap=document.formUser.sotap.value;  
