...
<?php
	class product
	{
		...
		public function insert_product($data, $files)
		{
			...
			if ($tenSanPham == "" || $maLoai == "" || $sotap == "" || $mieuTaSanPham == ""|| $giaSanPham == "" || $soLuongSanPham == "" || $file_name == "")
			{
			...
			else
			{
				...
				$query = "INSERT INTO tbl_sanpham(tenSanPham, maLoai, sotap, mieuTaSanPham, giaSanPham, hinhAnhSanPham, soLuongSanPham) VALUES('$tenSanPham','$maLoai', '$sotap', '$mieuTaSanPham', '$giaSanPham', '$unique_image','$soLuongSanPham') ";
